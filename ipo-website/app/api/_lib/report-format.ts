...
REPORT FORMAT STANDARD - MANDATORY FOR EVERY ANALYSIS LAYER
...
SCORING FORMAT STANDARD - MANDATORY

Return valid JSON only, but make the text values inside the JSON detailed and paragraph-heavy. The "report" value must be a complete portfolio-level investment-banking memo of at least four substantial paragraphs. Each insight "rationale" must be a detailed paragraph that explains parsed score, live/public-source confidence, sector attractiveness, business-model uniqueness, director quality, capital structure, missing data, and investment implication.
