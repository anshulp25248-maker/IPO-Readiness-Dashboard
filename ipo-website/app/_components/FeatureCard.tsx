...
export function FeatureCard({ title, href }: FeatureCardProps) {
  return (
    <Link
      href={href}
      className="group flex min-h-32 w-full items-center justify-center rounded-2xl border border-white/35 bg-white/15 px-6 py-8 text-center shadow-[0_20px_60px_rgba(15,23,42,0.18)] backdrop-blur-xl transition duration-300 ease-out hover:-translate-y-1 hover:scale-[1.025] hover:border-white/70 hover:shadow-[0_24px_80px_rgba(30,64,175,0.28)] focus:outline-none focus:ring-4 focus:ring-white/45"
    >
